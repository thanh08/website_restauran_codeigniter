	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-sm-center ">
				<h3>Thêm slide</h3>
				<a href="<?php echo base_url(); ?>sline/showsline" class="btn-warning btn-lg float-right">Chỉnh sửa slide <i class="fa fa-arrow-right" style="width: 20px !important;"></i> </a>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-8 offset-sm-2">
				<form action="<?php echo base_url(); ?>index.php/sline/updatesline" method="post" enctype="multipart/form-data">
					...
					<fieldset class="form-group">
						<label for="formGroupExampleInput2">Image Slide</label>
